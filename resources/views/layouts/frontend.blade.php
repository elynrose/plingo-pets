                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('message_log_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.message-logs.index') }}">
                                            {{ trans('cruds.messageLog.title') }}
                                        </a>
                                    @endcan
                                    @can('location_access')
                                    ...
                                    @endcan
                                    @can('request_care_access')
                                        <a class="dropdown-item" href="{{ route('frontend.request-cares.index') }}">
                                            {{ trans('cruds.requestCare.title') }}
                                        </a>
                                    @endcan
                                    @can('credit_access')
