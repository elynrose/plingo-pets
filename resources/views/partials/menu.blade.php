<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('app_setting_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/message-logs*") ? "c-show" : "" }} {{ request()->is("admin/locations*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('message_log_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.message-logs.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/message-logs") || request()->is("admin/message-logs/*") ? "c-active" : "" }}">
        ...
        @can('request_care_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.request-cares.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/request-cares") || request()->is("admin/request-cares/*") ? "c-active" : "" }}">
