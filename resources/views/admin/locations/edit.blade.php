    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.locations.update", [$location->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zip_code') ? 'is-invalid' : '' }}" type="text" name="zip_code" id="zip_code" value="{{ old('zip_code', $location->zip_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('official_usps_city_name') ? 'is-invalid' : '' }}" type="text" name="official_usps_city_name" id="official_usps_city_name" value="{{ old('official_usps_city_name', $location->official_usps_city_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('official_usps_state_code') ? 'is-invalid' : '' }}" type="text" name="official_usps_state_code" id="official_usps_state_code" value="{{ old('official_usps_state_code', $location->official_usps_state_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('official_state_name') ? 'is-invalid' : '' }}" type="text" name="official_state_name" id="official_state_name" value="{{ old('official_state_name', $location->official_state_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('primary_official_county_code') ? 'is-invalid' : '' }}" type="text" name="primary_official_county_code" id="primary_official_county_code" value="{{ old('primary_official_county_code', $location->primary_official_county_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('primary_official_county_name') ? 'is-invalid' : '' }}" type="text" name="primary_official_county_name" id="primary_official_county_name" value="{{ old('primary_official_county_name', $location->primary_official_county_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('official_county_code') ? 'is-invalid' : '' }}" type="text" name="official_county_code" id="official_county_code" value="{{ old('official_county_code', $location->official_county_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('timezone') ? 'is-invalid' : '' }}" type="text" name="timezone" id="timezone" value="{{ old('timezone', $location->timezone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('geo_point') ? 'is-invalid' : '' }}" type="text" name="geo_point" id="geo_point" value="{{ old('geo_point', $location->geo_point) }}">
