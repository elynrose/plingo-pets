...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.request-cares.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_rating') ? 'is-invalid' : '' }}" type="number" name="user_rating" id="user_rating" value="{{ old('user_rating', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('user_review') ? 'is-invalid' : '' }}" name="user_review" id="user_review">{!! old('user_review') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pet_rating') ? 'is-invalid' : '' }}" type="number" name="pet_rating" id="pet_rating" value="{{ old('pet_rating', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('pet_review') ? 'is-invalid' : '' }}" name="pet_review" id="pet_review">{!! old('pet_review') !!}</textarea>
