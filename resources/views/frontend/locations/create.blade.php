                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.locations.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="official_usps_city_name" id="official_usps_city_name" value="{{ old('official_usps_city_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="official_usps_state_code" id="official_usps_state_code" value="{{ old('official_usps_state_code', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="official_state_name" id="official_state_name" value="{{ old('official_state_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="primary_official_county_code" id="primary_official_county_code" value="{{ old('primary_official_county_code', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="primary_official_county_name" id="primary_official_county_name" value="{{ old('primary_official_county_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="official_county_code" id="official_county_code" value="{{ old('official_county_code', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="geo_point" id="geo_point" value="{{ old('geo_point', '') }}">
