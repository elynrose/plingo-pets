    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.request-cares.update", [$requestCare->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="zip_code" id="zip_code" value="{{ old('zip_code', $requestCare->zip_code) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="details" id="details" required>{{ old('details', $requestCare->details) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="start_date" id="start_date" value="{{ old('start_date', $requestCare->start_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="start_time" id="start_time" value="{{ old('start_time', $requestCare->start_time) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="end_date" id="end_date" value="{{ old('end_date', $requestCare->end_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="end_time" id="end_time" value="{{ old('end_time', $requestCare->end_time) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="user_rating" id="user_rating" value="{{ old('user_rating', $requestCare->user_rating) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="user_review" id="user_review">{!! old('user_review', $requestCare->user_review) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="pet_rating" id="pet_rating" value="{{ old('pet_rating', $requestCare->pet_rating) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="pet_review" id="pet_review">{!! old('pet_review', $requestCare->pet_review) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="credits" id="credits" value="{{ old('credits', $requestCare->credits) }}" step="1" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="closed" id="closed" value="1" {{ $requestCare->closed || old('closed', 0) === 1 ? 'checked' : '' }}>
