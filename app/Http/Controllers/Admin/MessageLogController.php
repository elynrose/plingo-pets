...
class MessageLogController extends Controller
{
    public function index()
    {
        ...
        return view('admin.messageLogs.index', compact('messageLogs'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.messageLogs.create', compact('users'));
    }
    ...
    public function store(StoreMessageLogRequest $request)
    {
        ...
        return redirect()->route('admin.message-logs.index');
    }
    ...
    public function edit(MessageLog $messageLog)
    {
        ...
        return view('admin.messageLogs.edit', compact('messageLog', 'users'));
    }
    ...
    public function show(MessageLog $messageLog)
    {
        ...
        return view('admin.messageLogs.show', compact('messageLog'));
    }
