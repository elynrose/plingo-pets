...
class RequestCareController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.requestCares.index', compact('requestCares'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.requestCares.create', compact('booked_bies', 'created_bies', 'pets'));
    }
    ...
    public function store(StoreRequestCareRequest $request)
    {
        ...
        return redirect()->route('frontend.request-cares.index');
    }
    ...
    public function edit(RequestCare $requestCare)
    {
        ...
        return view('frontend.requestCares.edit', compact('booked_bies', 'created_bies', 'pets', 'requestCare'));
    }
    ...
    public function show(RequestCare $requestCare)
    {
        ...
        return view('frontend.requestCares.show', compact('requestCare'));
    }
